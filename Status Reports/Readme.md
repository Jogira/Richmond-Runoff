...
| Week 9 Status Report | <ul><li>Look into how to turn the shapes on the map into actual areas with data values.</li><li>Look into MapBox and see if it can be used in a way that suits our needs</li><li>See how the shapes constructors work to see if we can add values to them</li></ul>| <ul/><li>JG - Added design documentation to Github and Edusource.</li></ul>| |
