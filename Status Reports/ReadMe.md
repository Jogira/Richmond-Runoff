...
| Week 8 Status Report | <ul><li>Experiment with the code to better understand the functionality and how we can use it for our needs.</li></ul>| <ul><li>Learned how the group placed shapes on their map</li><li>Planned to meet with another group to learn about ArcGIS and MapBox to see their uses</li></ul>| -None. |
| Week 9 Status Report | <ul><li>Look into how to turn the shapes on the map into actual areas with data values.</li><li>Look into MapBox and see if it can be used in a way that suits our needs</li><li>See how the shapes constructors work to see if we can add values to them. </li></ul>| <ul/><li>JG - Added design documentation to Github and Edusource <li> JN - Created optional plan and uploaded documentation.</li></li></ul>| -Not everyone can access the project.  | Set up a base map of Virginia.
| Week 10 Status Report | <ul><li>Figure out which plan we are going to follow</li></ul>| <ul><li>Found ways to use ArcGIS for exactly what we need</li><li>Decided on Python to be the language we use.</li></ul>| -Map is not isolated to just Richmond. | Shared the map and got the rest of the group members up to speed. 
| Week 11 Status Report | <ul><li>Start to use ArcGIS and connect it to a webpage</li></ul>| Got basemap completed and available to everyone. | -None. |
| Week 12 Status Report | Get a flood simulation going. Restrict LiDAR data to just Richmond. | Grabbed the LiDAR data for a massive chunk of Virginia. | LiDAR data covers much more than just Ricnmond. |
...
| Week 16 Status Report | Potentially bugfixing. No bugs are currently known.| Transferred the data gathered into a webapp. | -Never heard back from our sponsor. | The project is completed. 
